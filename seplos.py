...
import flask.scaffold, requests
...
class Batteries(Resource):
  def get(self, instance=None):
    seplos_batteries = {}
    seplos_batteries['data'] = query_seplos(rs485_device, baud_rate)

    return seplos_batteries

class index(Resource):
  def get(self):
    return "Seplos Pack Monitor API"

api.add_resource(Batteries, "/batteries")
